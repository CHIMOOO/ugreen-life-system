  ...
  <div class="relative min-h-screen overflow-hidden bg-retro-bg font-poppins text-retro-ink">
    ...
    <div class="relative z-10 mx-auto max-w-5xl px-5 py-8 sm:px-8">
      ...
      <section class="mb-12">
        ...
        <div class="mt-6 grid gap-5 sm:grid-cols-2">
          <div class="rounded-[24px] border-2 border-dashed border-retro-orange bg-retro-panel p-6 retro-shadow">
          ...
          <div class="rounded-[24px] border-2 border-dashed border-retro-teal bg-retro-panel p-6 retro-shadow">
