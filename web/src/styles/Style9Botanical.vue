...
// 评价墙主题：跟随植物自然配色（accent 用叶绿 bot-leaf）
const reviewTheme = {
  accent: '#3E6B47',
  panel: 'rounded-[28px] border border-bot-sage/50 bg-bot-cream/70 p-6 bot-card sm:p-8',
  heading: 'flex items-center gap-2 font-cormorant text-3xl font-semibold text-bot-leaf',
  sub: 'font-cormorant text-lg italic text-bot-ink/70',
  field: 'w-full rounded-2xl border border-bot-sage bg-white px-5 py-4 text-lg text-bot-ink placeholder-bot-sage/60 outline-none transition focus:border-bot-leaf focus:ring-2 focus:ring-bot-leaf/20',
  kindOff: 'border border-bot-sage text-bot-leaf hover:bg-bot-sage/15',
  item: 'rounded-[24px] border border-bot-sage/40 bg-bot-bg/60 p-4',
  empty: 'text-bot-ink/55',
};
</script>
        ...
        <div v-if="showForm" class="space-y-10">
          <div class="mx-auto w-full max-w-2xl">
            ...
            <ConfirmSubmitDialog :open="showConfirm" :rules="config.rulesLottery" :submitting="submitting"
              ...
              title="确认参与抽奖" icon="🌿" confirmText="🌿 确认提交" cancelText="再想想"
              :theme="{
                overlay: 'bg-bot-ink/50 backdrop-blur-sm',
                panel: 'bg-bot-cream text-bot-ink rounded-[28px] border border-bot-sage/50 bot-card font-poppins',
                heading: 'font-cormorant text-3xl font-semibold text-bot-leaf',
                sub: 'font-cormorant text-lg italic text-bot-ink/70',
                infoBox: 'rounded-2xl border border-bot-sage/50 bg-bot-bg/60',
                infoLabel: 'text-bot-leaf',
                infoName: 'text-bot-ink',
                rulesLabel: 'text-bot-leaf',
                rulesBox: 'rounded-2xl border-l-4 bg-bot-bg/60 text-bot-ink/80',
                cancelBtn: 'rounded-full border border-bot-sage text-bot-leaf hover:bg-bot-sage/15',
                confirmBtn: 'rounded-full bg-bot-leaf text-bot-cream tracking-wide hover:bg-bot-ink hover:shadow-lg',
              }"
          ...
          <div>
            ...
            <div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div v-for="(z, i) in period.prizes" :key="i" class="overflow-hidden rounded-[24px] border border-bot-sage/40 bg-bot-cream/70 bot-card transition hover:-translate-y-0.5">
                ...
                <div v-else class="grid aspect-video w-full place-items-center bg-bot-sage/20 text-6xl">🎁</div>
            ...
            <div class="mt-8 grid gap-5 sm:grid-cols-2">
              <div v-for="(g, gi) in prizeGroups" :key="gi" class="relative overflow-hidden rounded-[24px] border border-bot-sage/40 bg-bot-cream/70 p-6 bot-card">
                ...
                <div class="flex items-center gap-4">
                  <div class="aspect-video w-24 shrink-0 overflow-hidden rounded-2xl border border-bot-sage/50 bg-bot-bg">
