  ...
  <div class="relative min-h-screen paper-grid font-patrick text-sketch-ink">
    ...
    <div class="relative z-10 mx-auto max-w-5xl px-6 py-12 sm:px-8">
      ...
      <section v-if="lotteryOn" class="mb-20">
        <!-- 表单 -->
        <div v-if="showForm" class="grid gap-10 lg:grid-cols-5">
      ...
      <section class="mb-12">
        ...
        <div class="mt-6 grid gap-6 sm:grid-cols-2">
          <div class="border-[3px] border-dashed border-sketch-ink bg-white p-6 shadow-sketch-soft -rotate-1 wobbly-md">
